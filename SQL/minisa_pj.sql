...
-- Dumping structure for table minisa_pj.migrations
...
-- Dumping structure for table minisa_pj.statususers
CREATE TABLE IF NOT EXISTS `statususers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `FBS` int(11) NOT NULL,
  `BPmax` int(11) NOT NULL,
  `BPmin` int(11) NOT NULL,
...
-- Dumping structure for table minisa_pj.users
